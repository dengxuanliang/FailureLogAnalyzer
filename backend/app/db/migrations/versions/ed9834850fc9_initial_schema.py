...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('analysis_type', sa.Enum('rule', 'llm', 'manual', name='analysis_type'), nullable=False),
        sa.Column('error_types', postgresql.ARRAY(sa.String()), nullable=True),
        sa.Column('root_cause', sa.Text(), nullable=True),
        sa.Column('severity', sa.Enum('high', 'medium', 'low', name='severity_level'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('source', sa.Enum('rule', 'llm', name='tag_source'), nullable=False),
        sa.Column('confidence', sa.Float(), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    )
